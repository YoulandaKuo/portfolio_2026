...
export default function Footer() {
  return (
    <footer className="mt-[140px] px-11 py-[60px] border-t border-rule flex items-center justify-between font-mono text-[11px] tracking-[0.16em] uppercase text-ink-soft">
